...
A second evidence-traceable model-architecture case study is available at `examples/aurora-iclr-2026/`, based on a user-provided ICLR 2026 PDF about multimodal time-series foundation models.
